...
4. Prompt Copilot to generate the script
    ...
    Remember CoPilot is non-determinstic and may produce more files than these or leave some of these files out.  If you need some of them later you can use CoPilot to generate them at that time.
