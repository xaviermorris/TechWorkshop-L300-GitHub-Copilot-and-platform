...
- [Configure authentication for Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/configure-authentication?tabs=azure-cli){:target="_blank"}
- [Disable local authentication (key-based) for Azure AI Services](https://learn.microsoft.com/en-us/azure/ai-services/disable-local-auth){:target="_blank"}
- [Role-based access control (RBAC) for Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/concepts/rbac-azure-ai-foundry){:target="_blank"}

## Key Tasks

### 01: Review Current Application Authentication

Use GitHub Copilot Chat to verify that your application is using identity-only access for Azure AI Foundry and that no API keys are configured.
...
Use GitHub Copilot Chat to update your Bicep templates to disable API keys and enforce identity-only authentication for the Azure AI Foundry workspace.
